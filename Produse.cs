...
namespace LorelaiBoutique
{
	public partial class Produse : Form
	{
		...
		{
			string insertQuery = "INSERT INTO produse(fisier_imagine, imagine_mare,id_categ, nume_produs,prezentare,pret) VALUES( '" + timagMic.Text + "','" + timagMare.Text + "', '" + comboCateg.Text + "', '" + tNume.Text + "','" + tprez.Text + "', '" + tPret.Text + "')";
